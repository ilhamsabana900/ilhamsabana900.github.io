            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">No. Hp/Telp/</label>
                            <div class="col-md-7">
                ...
                <?php 
                    ...
                    if($yangcocok==1){
                        ...
                        echo "<script>alert('pendaftaran gagal, email ini sudah digunakan');</script>";
                        echo "<script>location='daftar.php';</script>";
                    }else{
                        //query insert ketable pelanggan
                        $koneksi->query("INSERT INTO pelanggan (nama_pelanggan,email_pelanggan,password_pelanggan,alamat_pelanggan,telepon_pelanggan)
